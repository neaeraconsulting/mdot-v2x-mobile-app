# v2x-mec-mobile-app
This is the main repository for all code related to the Connected Vehicle Mobile Edge Compute (CV-MEC) mobile application. For a full list of features available in the CV-MEC application please see the [supported feature list](docs/system_design/Feature_List.md)
