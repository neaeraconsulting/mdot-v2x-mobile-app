# V2X Mobile App
This is the main repository for all code related to the V2X Mobile App. 

![V2X Mobile App Logo](cv_mec/assets/images/v2x_logo.png)


For a full list of features available in the V2X Mobile App please see the 
- [supported feature list](docs/system_design/Feature_List.md)
- [changelog](docs/change_log.md)

## For Users
For users looking to see how to use the V2X Mobile App please see the V2X Mobile App users guide pages
- [Home Page Overview](docs/user_guide/Welcome_to_the_V2X_Mobile_App_Application.md)
...
## For Developers
For developers looking to get started with building and running the V2X Mobile App , please reference the app setup guide [here](cv_mec/README.md)
