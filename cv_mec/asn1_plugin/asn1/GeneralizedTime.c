 ...
 */
#if defined(__FreeBSD__) || defined(__OpenBSD__) || (defined(__GNUC__) && defined(__APPLE_CC__)) || (defined __GLIBC__ && __GLIBC__ >= 2)
...
asn_TYPE_descriptor_t asn_DEF_GeneralizedTime = {
		...
		sizeof(asn_DEF_GeneralizedTime_tags) / sizeof(asn_DEF_GeneralizedTime_tags[0]) - 2,
		asn_DEF_GeneralizedTime_tags,
		sizeof(asn_DEF_GeneralizedTime_tags) / sizeof(asn_DEF_GeneralizedTime_tags[0]),
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
				0,
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
 ...
 */
int GeneralizedTime_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
...
local_finish:
	 ...
	 * Validation.
	 */
	if ((tm_s.tm_mon > 12 || tm_s.tm_mon < 1) || (tm_s.tm_mday > 31 || tm_s.tm_mday < 1) || (tm_s.tm_hour > 23) || (tm_s.tm_sec > 60))
	{
		errno = EINVAL;
		return -1;
	}
...
int GeneralizedTime_compare(const asn_TYPE_descriptor_t *td, const void *aptr,
														const void *bptr)
{
