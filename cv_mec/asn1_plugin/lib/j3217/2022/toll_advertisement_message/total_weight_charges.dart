...
class TotalWeightCharges extends Choice_WeightCharge{
    ...
    TotalWeightCharges.fromC(C.TotalWeightCharges c_obj){
        weightLimit = WeightLimitInteger(c_obj.weightLimit);
        weightLimitUnits = WeightLimitUnits.values[c_obj.weightLimitUnits];
        weightCharge = PaymentFee.fromC(c_obj.weightCharge);
    }
}
class WeightLimitInteger {
    late int weightLimitInteger;
    WeightLimitInteger(int value): weightLimitInteger = value;
}