...
class TimeChargesTable{
    ...
    TimeChargesTable.fromC(C.TimeChargesTable c_obj){
        maxTime = MaxTimeInteger(c_obj.maxTime);
        chargesTable = ChargesTable.fromC(c_obj.chargesTable);
    }
}

class MaxTimeInteger {
    late int maxTimeInteger;
    MaxTimeInteger(int value): maxTimeInteger = value;
}
