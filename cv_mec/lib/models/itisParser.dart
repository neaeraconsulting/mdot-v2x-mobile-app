...
class ItisParser {
  ...
  ItisParser(){
    BASIC_ADVISORY_CODE_MAP = {
      ACCIDENT: ItisCode.withImage(ACCIDENT, "Accident", AssetImage("$imageDirectory/$ACCIDENT.png")),
      INCIDENT: ItisCode.withImage(INCIDENT, "Incident", AssetImage("$imageDirectory/$INCIDENT.png")),
      HAZARDOUS_MATERIAL_SPILL: ItisCode.withImage(HAZARDOUS_MATERIAL_SPILL, "Hazardous Material Spill", AssetImage("$imageDirectory/$HAZARDOUS_MATERIAL_SPILL.png")),
      CLOSED: ItisCode.withImage(CLOSED, "Closed", AssetImage("$imageDirectory/$CLOSED.png")),
      CLOSED_FOR_THE_SEASON: ItisCode.withImage(CLOSED_FOR_THE_SEASON, "Closed for the Season", AssetImage("$imageDirectory/$CLOSED_FOR_THE_SEASON.png")),
      AVALANCHE_CONTROL_ACTIVITIES: ItisCode.withImage(AVALANCHE_CONTROL_ACTIVITIES, "Avalanche Control Activities", AssetImage("$imageDirectory/$AVALANCHE_CONTROL_ACTIVITIES.png")),
      ACCIDENT: ItisCode.withImage(ACCIDENT, "Accident", AssetImage("$imageDirectory/$ACCIDENT.png")),
      HERD_OF_ANIMALS_ON_ROADWAY: ItisCode.withImage(HERD_OF_ANIMALS_ON_ROADWAY, "Herd of Animals on Roadway", AssetImage("$imageDirectory/$HERD_OF_ANIMALS_ON_ROADWAY.png")),
      ROCKFALL: ItisCode(ROCKFALL, "Rock Fall"),
      LANDSLIDE: ItisCode.withImage(LANDSLIDE, "Landslide", AssetImage("$imageDirectory/$LANDSLIDE.png")),
      WIDE_LOAD: ItisCode.withImage(WIDE_LOAD, "Wide Load", AssetImage("$imageDirectory/$WIDE_LOAD.png")),
      NO_TRAILERS: ItisCode.withImage(NO_TRAILERS, "Wide Load", AssetImage("$imageDirectory/$NO_TRAILERS.png")),
      WILDFIRE: ItisCode.withImage(WILDFIRE, "Wild Fire", AssetImage("$imageDirectory/$WILDFIRE.png")),
      WEATHER_EMERGENCY: ItisCode.withImage(WEATHER_EMERGENCY, "Wild Fire", AssetImage("$imageDirectory/$WEATHER_EMERGENCY.png")),
      MAJOR_EVENT: ItisCode.withImage(MAJOR_EVENT, "Major Event", AssetImage("$imageDirectory/$MAJOR_EVENT.png")),
      SEVERE_WEATHER: ItisCode.withImage(SEVERE_WEATHER, "Severe Weather", AssetImage("$imageDirectory/$SEVERE_WEATHER.png")),
      SNOW: ItisCode.withImage(SNOW, "Snow", AssetImage("$imageDirectory/$SNOW.png")),
      WINTER_STORM: ItisCode.withImage(WINTER_STORM, "Winter Storm", AssetImage("$imageDirectory/$WINTER_STORM.png")),
      RAIN: ItisCode.withImage(RAIN, "Rain", AssetImage("$imageDirectory/$RAIN.png")),
      STRONG_WINDS: ItisCode.withImage(STRONG_WINDS, "Strong Winds", AssetImage("$imageDirectory/$STRONG_WINDS.png")),
      FOG: ItisCode.withImage(FOG, "Fog", AssetImage("$imageDirectory/$FOG.png")),
      VISIBILITY_REDUCED: ItisCode.withImage(VISIBILITY_REDUCED, "Visibility Reduced", AssetImage("$imageDirectory/$VISIBILITY_REDUCED.png")),
      BLOWING_SNOW: ItisCode.withImage(BLOWING_SNOW, "Rain", AssetImage("$imageDirectory/$BLOWING_SNOW.png")),
      BLACK_ICE: ItisCode.withImage(BLACK_ICE, "Black Ice", AssetImage("$imageDirectory/$BLACK_ICE.png")),
      WET_PAVEMENT: ItisCode.withImage(WET_PAVEMENT, "Wet Pavement", AssetImage("$imageDirectory/$WET_PAVEMENT.png")),
      ICE: ItisCode.withImage(ICE, "Ice", AssetImage("$imageDirectory/$ICE.png")),      
      ICY_PATCHES: ItisCode.withImage(ICY_PATCHES, "Icy Patches", AssetImage("$imageDirectory/$ICY_PATCHES.png")),
      SNOW_DRIFTS: ItisCode.withImage(SNOW_DRIFTS, "Snow Drifts", AssetImage("$imageDirectory/$SNOW_DRIFTS.png")),
      DRY_PAVEMENT: ItisCode.withImage(DRY_PAVEMENT, "Dry Pavement", AssetImage("$imageDirectory/$DRY_PAVEMENT.png")),
      DIRT_ROAD_SURFACE: ItisCode.withImage(DIRT_ROAD_SURFACE, "Dirt Road Surface", AssetImage("$imageDirectory/$DIRT_ROAD_SURFACE.png")),
      MILLED_ROAD_SURFACE: ItisCode.withImage(MILLED_ROAD_SURFACE, "Milled Road Surface", AssetImage("$imageDirectory/$MILLED_ROAD_SURFACE.png")),
      SNOW_TIRES_OR_CHAINS_REQUIRED: ItisCode.withImage(SNOW_TIRES_OR_CHAINS_REQUIRED, "Snow Tires or Chaines Required", AssetImage("$imageDirectory/$SNOW_TIRES_OR_CHAINS_REQUIRED.png")),
      ICY_PATCHES: ItisCode.withImage(ICY_PATCHES, "Icy Patches", AssetImage("$imageDirectory/$ICY_PATCHES.png")),
      DRIVE_CAREFULLY: ItisCode.withImage(DRIVE_CAREFULLY, "Drive Carefully", AssetImage("$imageDirectory/$DRIVE_CAREFULLY.png")),
      DRIVE_WITH_EXTREME_CAUTION: ItisCode.withImage(DRIVE_WITH_EXTREME_CAUTION, "Drive with Extreme Caution", AssetImage("$imageDirectory/$DRIVE_WITH_EXTREME_CAUTION.png")),
      INCREASE_NORMAL_FOLLOWING_DISTANCE: ItisCode.withImage(INCREASE_NORMAL_FOLLOWING_DISTANCE, "Increase Normal Following Distance", AssetImage("$imageDirectory/$INCREASE_NORMAL_FOLLOWING_DISTANCE.png")),
      PREPARE_TO_STOP: ItisCode.withImage(PREPARE_TO_STOP, "Prepare to Stop", AssetImage("$imageDirectory/$PREPARE_TO_STOP.png")),
      STOP_AT_NEXT_SAFE_PLACE: ItisCode.withImage(STOP_AT_NEXT_SAFE_PLACE, "Stop at Next Safe Place", AssetImage("$imageDirectory/$STOP_AT_NEXT_SAFE_PLACE.png")),
      ONLY_TRAVEL_IF_ABSOLUTELY_NECESSARY: ItisCode.withImage(ONLY_TRAVEL_IF_ABSOLUTELY_NECESSARY, "Only travel if absolutely necessary", AssetImage("$imageDirectory/$ONLY_TRAVEL_IF_ABSOLUTELY_NECESSARY.png")),
      FALLING_ROCKS: ItisCode.withImage(FALLING_ROCKS, "Falling Rocks", AssetImage("$imageDirectory/$FALLING_ROCKS.png")),
    };

    BASIC_WORK_ZONE_CODE_MAP = {
      REDUCED_TO_ONE_LANE: ItisCode.withImage(RIGHT_LANE_CLOSED_AHEAD, "Reduce to one Lane", AssetImage("$imageDirectory/$RIGHT_LANE_CLOSED_AHEAD.png")),
      ROAD_CONSTRUCTION: ItisCode.withImage(ROAD_CONSTRUCTION, "Road Construction", AssetImage("$imageDirectory/$ROAD_CONSTRUCTION.png")),
      GRAVEL_ROAD_SURFACE: ItisCode(GRAVEL_ROAD_SURFACE, "Gravel Road Surface"),
      LOOK_OUT_FOR_WORKERS: ItisCode(LOOK_OUT_FOR_WORKERS, "Look Out for Workers"),
      KEEP_TO_RIGHT: ItisCode.withImage(KEEP_TO_RIGHT, "Keep to Right", AssetImage("$imageDirectory/$KEEP_TO_RIGHT.png")),
      KEEP_TO_LEFT: ItisCode.withImage(KEEP_TO_LEFT, "Keep to Left", AssetImage("$imageDirectory/$KEEP_TO_LEFT.png")),
    };
  ...
  Future<ItisCode> getItisRepresentation(TravelerDataFrame frame) async{
    ...
    if(content is WorkZone){ // Work Zone
      return parseItisAlertFromWorkZone(content as WorkZone);
    }else if(content is ExitService){ // Exit Service
      return parseItisAlertFromExitService(content as ExitService);
    }else if(content is GenericSignage){ // Generic Signage
      return parseItisAlertFromGenericSignage(content as GenericSignage);
    }else if(content is SpeedLimit){ // Speed Limit
      return parseItisAlertFromSpeedLimit(content as SpeedLimit);
    }else if(content is ITIS_ITIScodesAndText){ // Advisory
      return parseItisCodeFromITISCodesAndText(content as ITIS_ITIScodesAndText);
    }else{
  ...
  Future<ItisCode> parseItisCodeFromITISCodesAndText(ITIS_ITIScodesAndText itis) async {
    if (itis.item.isNotEmpty){
      if(itis.item.first is ITIScodes){
        ...
        }else if(itis.item.length >=2 && (itis.item[0] as ITIScodes).itisCode == PEDESTRIAN && (itis.item[1] as ITIScodes).itisCode == CROSSING){
          return ItisCode.withImage(PEDESTRIAN, "Pedestrian Crossing", AssetImage("$imageDirectory/pedcrossing.png"));
        }else if(code == SPEED_LIMIT){
          if(itis.item.length == 3){ // Basic Speed Limit
            ...
            if(speed != -1){
              ...
              if(image != null){
                ItisCode code = ItisCode.withImage(SPEED_LIMIT, "Speed Limit", image);
        ...
        return ItisCode.withImage(PEDESTRIAN, "Pedestrian Crossing", AssetImage("$imageDirectory/pedcrossing.png")); //AssetImage("$imageDirectory/pedcrossing.png")
          ...
          if(code == 8196){
            if(wz.item.length > 1 && wz.item[1] is ITIScodes){
              if((wz.item[1] as ITIScodes).itisCode == 771){
                return ItisCode.withImage(771, "Right Lane Closed Ahead", AssetImage("$imageDirectory/$RIGHT_LANE_CLOSED_AHEAD.png"));
              }
            }
          }
          else if(code == 8195){
            if(wz.item.length > 1 && wz.item[1] is ITIScodes){
              if((wz.item[1] as ITIScodes).itisCode == 771){
                return ItisCode.withImage(771, "Left Lane Closed Ahead", AssetImage("$imageDirectory/$LEFT_LANE_CLOSED_AHEAD.png"));
              }
            }
          }
    ...
    if (sl.item.isNotEmpty){
      if(sl.item.first is ITIScodes){
        ...
        if(BASIC_SPEED_LIMIT_CODE_MAP.containsKey(code)){
          ...
          if(sl.item.length == 3){ // Basic Speed Limit
          ...
          else if(sl.item.length == 5){ // Reduce Speed Ahead
          ...
          if(image != null){
              ItisCode code = ItisCode.withImage(SPEED_LIMIT, "Reduce Speed Ahead", image);
  ...
  Future<ImageProvider?> getSpeedImage(int speedLimit) async{
    final ByteData assetImageByteData = await rootBundle.load('$imageDirectory/$SPEED_LIMIT.png');
    ...
    if(assetImageByteData != null){
      ...
      if(baseSizeImage != null){
        img.drawString(baseSizeImage, "$speedLimit", font: font, color: img.ColorRgb8(0, 0, 0), y: 120);
  ...
  Future<ImageProvider?> getSpeedAheadImage(int speedLimit) async{
    final ByteData assetImageByteData = await rootBundle.load('$imageDirectory/$REDUCE_YOUR_SPEED.png');
    ...
    if(assetImageByteData != null){
      img.Image? baseSizeImage = img.decodeImage(assetImageByteData.buffer.asUint8List());
      if(baseSizeImage != null){
        img.drawString(baseSizeImage, "$speedLimit", font: font, color: img.ColorRgb8(0, 0, 0), y: yOffset);
        return MemoryImage(img.encodePng(baseSizeImage));
      }
    }
    return null;
  ...
  Future<ImageProvider?> getSpeedAdvisoryImage(int speedLimit) async{
    ...
    if(assetImageByteData != null){
      img.Image? baseSizeImage = img.decodeImage(assetImageByteData.buffer.asUint8List());
      if(baseSizeImage != null){
        img.drawString(baseSizeImage, "$speedLimit", font: font, color: img.ColorRgba8(0,0,0,200), y: 30);
        return MemoryImage(img.encodePng(baseSizeImage));
      }
    }
    return null;
