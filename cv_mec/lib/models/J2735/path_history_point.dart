...
import 'package:cv_mec/models/j2735/coarse_heading.dart';
import 'package:cv_mec/models/j2735/offset_ll_b18.dart';
import 'package:cv_mec/models/j2735/positional_accuracy.dart';
import 'package:cv_mec/models/j2735/speed.dart';
import 'package:cv_mec/models/j2735/time_offset.dart';
import 'package:cv_mec/models/j2735/vert_offset_b12.dart';
...
class PathHistoryPoint {
  ...
  PathHistoryPoint.fromC(C.PathHistoryPoint c_pathHistoryPoint) {
    ...
    if (c_pathHistoryPoint.posAccuracy.address != 0) {
      posAccuracy =
          PositionalAccuracy.fromC(c_pathHistoryPoint.posAccuracy.ref);
    }
