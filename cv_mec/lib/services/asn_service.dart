...
class ASNService extends GetxController {
  ...
  final String psmTemplate = "00201A0000020000000000000035A4E9006B49D1FF0000FFFF00000000";
  ...
  ASNService() {
    ...
    checkStartFlags = [TIM_START_FLAG, BSM_START_FLAG, MAP_START_FLAG, SPAT_START_FLAG, PSM_START_FLAG];
    messageTypeMap = {
  ...
  SensorDataSharingMessage parseSdsm(Pointer<Pointer<Void>> message) {
    ...
    print("Turtle ${messageFrame.value.present}");
  ...
  void setPsmTime(Pointer<Pointer<Void>> message, DateTime time) {
    Pointer<C.MessageFrame> messageFrameValuePtr = message.value.cast<C.MessageFrame>();
    C.MessageFrame messageFrame = messageFrameValuePtr.ref;
    C.PersonalSafetyMessage psm = messageFrame.value.choice.PersonalSafetyMessage;
