...
class ApiService extends GetxController {
  ...
  Future getRegistration(
      String token, String clientType, String clientSubtype) async {
    try {
  ...
  Future getConnection(String token, String deviceID, double lat, double long,
      String networkType) async {
    try {
      print("Registring Device");
      // String imei = await DeviceImei().getDeviceImei() ?? "";
