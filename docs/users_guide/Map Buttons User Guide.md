...
[Car Icon Button Bicycle](docs/images/Map_Buttons_User_Guide_Page/Car_Icon_Button_Bicycle.png)
[Car Icon Button Vehicle](docs/images/Map_Buttons_User_Guide_Page/Car_Icon_Button_Vehicle.png)
...
[Log Data Button Bicycle](docs/images/Map_Buttons_User_Guide_Page/Log_Data_Button_Bicycle.png)
[Log Data Button Vehicle](docs/images/Map_Buttons_User_Guide_Page/Log_Data_Button_Vehicle.png)
...
3.  Settings page: allows users to select various setting preferences. [See the Settings User Guide](<Settings_User_Guide.md>)

[Home Map Settings Button Bicycle](docs/images/Map_Buttons_User_Guide_Page/Home_Map_Settings_Button_Bicycle.png)
[Home Map Settings Button Vehicle](docs/images/Map_Buttons_User_Guide_Page/Home_Map_Settings_Button_Vehicle.png)
...
The “Vehicle Stats” allows users to click “Connect to [OBD-II Connection](docs/images/Map_Buttons_User_Guide_Page/OBD-II_Connection.png)". This button will show “Select a Device”, which is a list of devices that are available for the user to connect to.

The MPH or Miles Per Hour will show the rate of speed the user is traveling in a vehicle.

[Vehicle Stats](docs/images/Map_Buttons_User_Guide_Page/Vehicle_Stats.png)
