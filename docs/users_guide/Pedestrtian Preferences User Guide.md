...
[Pedestrian Button](docs/images/Pedestrian_Preferences_User_Guide_Page/Pedestrian_Button.png)
...
[Select a Config](docs/images/Pedestrian_Preferences_User_Guide_Page/Select_a_Config.png)

These are the configuration options for Public Safety Workers. Each selection has a unique icon that displays on the map.

[Public Safety Workers](docs/images/Pedestrian_Preferences_User_Guide_Page/Public_Safety_Workers.png)
...
[Pedestrian on Map](docs/images/Pedestrian_Preferences_User_Guide_Page/Pedestrian_on_Map.png)
