...
[Vehicle Button](docs/images/Vehicle_Preferences_User_Guide_Page/Vehicle_Button.png)

**Step 2**: Click “Add New”

[Add New](docs/images/Vehicle_Preferences_User_Guide_Page/Add_New.png)
...
[Vehicle Configuration](docs/images/Vehicle_Preferences_User_Guide_Page/Vehicle_Configuration.png)
...
[Vehicle Classification](docs/images/Vehicle_Preferences_User_Guide_Page/Vehicle_Classification.png)
    
6.  OBD-II Connection (Optional- see [OBDI-II Setup guide](<OBDI-II_Setup_Guide.md>))

[OBD-II Connection](docs/images/Vehicle_Preferences_User_Guide_Page/OBD-II_Connection.png)
...
[Test Vehicle #1](docs/images/Vehicle_Preferences_User_Guide_Page/Test_Vehicle_1.png)

**Step 4:** Click “Save”

[Save Test Vehicle #1](docs/images/Vehicle_Preferences_User_Guide_Page/Save_Test_Vehicle_1.png)
...
[Choose a Vehicle](docs/images/Vehicle_Preferences_User_Guide_Page/Choose_a_Vehicle.png)

The user can delete the vehicle by clicking the trash can icon.

[Trash Can Icon](docs/images/Vehicle_Preferences_User_Guide_Page/Trash_Can_Icon.png)
...
[Sub Trash Can Icon](docs/images/Vehicle_Preferences_User_Guide_Page/Sub_Trash_Can_Icon.png)
...
[Skip Button](docs/images/Vehicle_Preferences_User_Guide_Page/Skip_Button.png)
...
To read more about the map buttons, read the [Map Buttons User Guide](<Map_Buttons_User_Guide.md>)
...
[Bus Vehicle on Map](docs/images/Vehicle_Preferences_User_Guide_Page/Bus_Vehicle_on_Map.png)
